...
export const TEAM_MEMBERS: MemberItem[] = [
  ...
  },
  {
    ...
    name: 'Shivam Prasad',
    role: 'Vice President',
    image: '/team/vice_president.jpeg',
    // linkedin: '#',
  },
  {
    id: 3,
    ...
    image: '/team/joint_secretary.jpeg',
    // linkedin: '#',
  },
  {
    id: 4,
...
export const EVENTS: EventItem[] = [
  {
    id: 2,
    title: `CHAINQUEST`,
    imageURL: 'event_posters/chainquest_updated.jpg',
    imageDarkURL: 'event_posters/chainquest_updated.jpg',
    date: 'April 10, 2026',
    time: '9:00 AM Onwards',
    location: 'C3 Seminar Hall, Ground Floor',
    ...
    status: 'Upcoming',
    link: 'https://chainquest-backend.onrender.com/',
    googleSheetId: '',
    formFields: [],
  },
  {
